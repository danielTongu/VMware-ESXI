...
$logoutButton.Location = New-Object System.Drawing.Point(10, 500)
$logoutButton.Size = New-Object System.Drawing.Size(180, 40)
$logoutButton.Add_Click({
    $form.Close()
    Start-Process powershell.exe -ArgumentList "-ExecutionPolicy Bypass -File `"$PSScriptRoot\powershell-Login.ps1`""
})
